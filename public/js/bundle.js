...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5kcmlhbnN5YWgiLCJhIjoiY2s2amMyM3doMDd1aTNrcDF3aG5mdHd4cCJ9.3_fMY2wbP57QIoK9p85sqg';
...
var stripe = Stripe('pk_test_RhbRTyCnAU8hAuvQ5Eu6gtv700yCkRWnHn');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // create checkout form + process + charge credit card
...
if (updateUser) {
  updateUser.addEventListener('submit', function (el) {
    el.preventDefault();
    var formData = new FormData();
    formData.append('name', document.getElementById('name').value);
    formData.append('email', document.getElementById('email').value);
    formData.append('photo', document.getElementById('photo').files[0]);
    (0, _updateData.updateData)(formData, 'data');
  });
}
